...
import com.fase3.techchallenge.fiap.infrastructure.reserva.controller.ReservaControllerTest;
...
public class ComentarioControllerTest {
    ...
    class RegistrarComentario {
        ...
        void devePermitirRegistrarComentario() throws Exception {
            ...
            //Act
            mockMvc.perform(post("/comentarios").content(ReservaControllerTest.asJsonString(comentarioInsertDTO)).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isCreated());
